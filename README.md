...
I created two Hadoop AMI's as a result of this process.

**NOTE**: The goal behind `ami-331a9b53` was to have it configured to serve as all nodes in a cluster. I have included the second AMI just in case.

1. `ami-331a9b53`: `ravaliya-namenode-hadoop-ami`
2. `ami-62199802`: `ravaliya-datanode-hadoop-ami`

Both AMI's are publicly available.
...
```
Here, I deviate from the guide<sup>[1]</sup>, which uses version `1.7.0`.
...
There are four key files that have to be updated across all nodes. Let's look at each one individually:
...
Next, I break the tasks assigned into three distinct MapReduce jobs:

### Task 1

- "Computes how many times the words “education”, “politics”, “sports”, and “agriculture” appear in each file."
